<head>
    ...
    <link rel="stylesheet" href="{{asset("vendors/iconic-fonts/font-awesome/css/all.min.css")}}">
    ...
    <script src={{asset("assets/js/clients.js")}}>
    </script>
    <script src={{asset("assets/js/Chart.Financial.js")}}>
    </script>
